    ...
    return (
        ...
        <div className='container'>
            ...
            <div className='form-group'>
                ...
                <input type='text' value={form.name} onChange={onChange('name')} className='form-control' id='name' placeholder='Nome do Serie'/>
            </div>
            <div className='form-group'>
                <label Htmlfor="name">Comentários</label>
                <input type='text' value={form.comments} onChange={onChange('comments')} className='form-control' id='name' placeholder='Nome do Serie'/>
            </div>
            <div className='form-group'>
